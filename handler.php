...
class UploadHandler {
    ...
    public function getInitialFiles() {
        ...
        for ($i = 0; $i < 5000; $i++) {
            array_push($initialFiles, array("name" => "name" + $i, uuid => "uuid" + $i, thumbnailUrl => "fu.png"));
        }
    ...
    public function handleDelete($uploadDirectory, $name=null)
    {
        ...
        $target = join(DIRECTORY_SEPARATOR, array($targetFolder, $name));
